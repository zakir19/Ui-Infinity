  ...
  <CardFooter className="flex justify-between">
    ...
    <button className="text-sm text-blue-500 font-medium">Continue</button>
            ...
            <CardShowcase 
              ...
              code={`<TiltCard className="w-full max-w-md bg-gradient-to-br from-neon-purple/20 to-neon-cyan/20 border border-white/10 p-6 h-64">
  <div className="flex flex-col h-full justify-center items-center text-center">
    ...
    <p className="text-gray-400 text-sm">Move your cursor to see the tilt effect</p>
            ...
            <CardShowcase 
              ...
              code={`<GlassCard className="w-full max-w-md p-6 h-64">
  <div className="flex flex-col h-full justify-center items-center text-center">
    ...
    <p className="text-gray-400 text-sm">Sleek glassmorphism effect with backdrop blur</p>
            ...
            <CardShowcase 
              ...
              code={`<GradientBorder className="w-full max-w-md h-64">
