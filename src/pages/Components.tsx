...
// Helper components must be defined before usage in the main component
...
const ComponentItem: React.FC<{
  ...
  isNew: boolean;
  onView?: () => void;
}> = ({ name, description, isNew, onView }) => (
  <motion.div
    className="glass-morphism rounded-xl overflow-hidden border border-white/10 hover:border-neon-purple/30 transition-colors h-full relative"
    ...
    <div className="min-h-screen flex flex-col">
      <div className="pt-32 pb-12 bg-gradient-to-b from-black/40 to-transparent">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gradient mb-4">Component Library</h1>
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            A collection of beautiful, accessible, and customizable UI components for your next React project.
          </p>
        </div>
      </div>
            ...
            <div className="lg:w-3/4">
              <div className="mb-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  <CategoryCard title="Buttons" description="Interactive UI elements for actions" onClick={() => navigate('/buttons')} />
                  <CategoryCard title="Cards" description="Content containers with flexible layouts" onClick={() => navigate('/cards')} />
                  <CategoryCard title="Navigation" description="Menus, tabs, and other navigational elements" onClick={() => navigate('/navigation')} />
                  <CategoryCard title="Forms" description="Input controls and data collection elements" onClick={() => navigate('/forms')} />
                  <CategoryCard title="Modals" description="Dialog boxes and popup interfaces" onClick={() => navigate('/modals')} />
                  <CategoryCard title="Layout" description="Structural components for page organization" onClick={() => navigate('/layout')} />
                  <CategoryCard title="Feedback" description="Status indicators and notifications" onClick={() => navigate('/feedback')} />
                  <CategoryCard title="Effects" description="Visual interactions and animations" onClick={() => navigate('/effects')} />
                  <CategoryCard title="Animation" description="Motion and transition effects" onClick={() => navigate('/animation')} />
                  <CategoryCard title="Typography" description="Text styling and animations" onClick={() => navigate('/typography')} />
                  <CategoryCard title="Grids" description="Modern layout systems" onClick={() => navigate('/grids')} />
                  <CategoryCard title="3D Effects" description="Depth and perspective elements" onClick={() => navigate('/3d-effects')} />
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <TiltCard className="h-72 bg-gradient-to-br from-neon-purple/20 to-neon-cyan/20 border border-white/10 p-8">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p className="text-center text-gray-400 mt-2">Move your cursor to see the tilt effect</p>
                    </div>
                  </TiltCard>
                  ...
                  <GradientBorder className="h-72">
                    <div className="flex flex-col items-center justify-center h-full w-full p-4">
                      ...
                      <p className="text-center text-gray-400 mt-2">Animated gradient border effect</p>
                    </div>
                  </GradientBorder>
                  ...
                  <GlassCard className="h-72 flex items-center justify-center">
                    <Sparkles className="text-center p-8">
                      ...
                      <p className="text-gray-400 mt-2">Text with animated sparkle effects</p>
                    </Sparkles>
                  </GlassCard>
