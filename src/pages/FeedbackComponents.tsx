...
shadcnToast({
  ...
  variant: "default",
            ...
            <FeedbackShowcase 
              ...
              code={`<div className="bg-green-500/20 border border-green-500/30 text-green-300 px-4 py-3 rounded-md flex items-start">
...
<div className="space-y-1">
  ...
  <input
    ...
    id="email"
    value="notanemail"
    className="w-full px-4 py-2 rounded-md bg-black/20 border border-red-500 text-white focus:outline-none focus:ring-2 focus:ring-red-500"
  />
...
<div className="space-y-1">
  ...
  <input
    ...
    id="password"
    value="pass123"
    className="w-full px-4 py-2 rounded-md bg-black/20 border border-yellow-500 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500"
  />
...
<div className="grid grid-cols-3 gap-2">
  ...
  <div className="h-16 bg-white/10 rounded animate-pulse"></div>
            ...
            <FeedbackShowcase 
              ...
              code={`<div className="flex flex-col items-center justify-center text-center p-6">
  ...
  <button className="px-4 py-2 bg-neon-purple text-white rounded-md hover:bg-neon-purple/90">
    Create Project
  </button>
</div>`}>
      ...
      <section className="py-12 bg-black/20">
        <div className="container mx-auto px-4">
          ...
          <div className="glass-morphism p-6 rounded-xl overflow-hidden relative group">
            <CopyButton 
              code={`// Using Toast Notifications
import { toast } from 'sonner';
