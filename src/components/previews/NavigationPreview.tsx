...
const NavigationPreview = () => {
  const navigationCode = `<div className="w-full flex flex-col items-center justify-center">
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center group relative">
      <CopyButton code={navigationCode} className="opacity-0 group-hover:opacity-100" />
      <div className="w-full h-8 bg-black/40 rounded-md flex items-center px-2 mb-2">
        <div className="w-6 h-6 bg-neon-purple/50 rounded-full mr-2"></div>
        <div className="flex-1"></div>
        <div className="flex gap-2">
